...
{
    #region Methods
    public static OperationResult Validate(short year, short month, decimal balance, int bucketId) 
        => OperationResult.MakeSuccess()
            ...
            .With(bucketId, nameof(bucketId)).GreaterThen(0, "BucketId is required.")
            .Result;
